...
var suite55 = []struct {
	...
	{name: "constructs", pending: "<close>"},
	{name: "coroutine", pending: "<close>, coroutine.close"},
	{name: "cstack", pending: "<close>"},
