...
var suite55 = []struct {
	...
	{name: "attrib", returns: "27", pending: "<const>/<close> attributes"},
	...
	{name: "calls", returns: "deep", pending: "__call chains (5.5)"},
	...
	{name: "strings", pending: "<const>/<close> attributes"},
