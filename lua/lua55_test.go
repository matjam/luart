...
var suite55 = []struct {
	...
	{name: "attrib", returns: "27", pending: "<const>/<close> attributes, global declarations"},
	{name: "big", wrapped: true, pending: "tracebacks name metamethods ('newindex')"},
	{name: "bitwise", pending: "global declarations (in bwcoercion.lua), string.pack"},
	{name: "bwcoercion", skip: "a module bitwise.lua loads"},
	{name: "calls", returns: "deep", pending: "global declarations"},
	{name: "closure", pending: "global declarations"},
	{name: "code", skip: "needs C Lua's internal test library (T)"},
	{name: "constructs", pending: "<const>/<close> attributes"},
	{name: "coroutine", pending: "<const>/<close> attributes, coroutine.close"},
	{name: "cstack", pending: "<const>/<close> attributes"},
	{name: "db", pending: "global declarations"},
	{name: "errors", pending: "error(nil) gives \"<no error object>\" (5.5)"},
	{name: "events", returns: "12", pending: "__eq from either operand (5.4)"},
	{name: "files", pending: "global declarations"},
	...
	{name: "literals", pending: "global declarations, \\u escapes"},
	{name: "locals", returns: "5", pending: "global declarations, to-be-closed variables"},
	{name: "main", skip: "tests the standalone interpreter, lua.c"},
	{name: "math", pending: "global declarations, <const>/<close> attributes"},
	{name: "memerr", skip: "needs C Lua's internal test library (T) to fail allocations"},
	{name: "nextvar", pending: "global declarations, table.create"},
	{name: "pm", pending: "global declarations, utf8 library"},
	{name: "sort", strip: true, pending: "table.create"},
	{name: "strings", pending: "global declarations, <const>/<close> attributes"},
	{name: "tpack", pending: "string.pack"},
	{name: "tracegc", skip: "a module gc.lua loads"},
	{name: "utf8", pending: "global declarations, utf8 library"},
