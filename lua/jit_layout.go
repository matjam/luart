...
const (
	...
	offUDBuf     = uint32(unsafe.Offsetof(userData{}.buf))
	offBufPtr    = uint32(unsafe.Offsetof(buffer{}.ptr))
	offBufLen    = uint32(unsafe.Offsetof(buffer{}.len))
	offBufKind   = uint32(unsafe.Offsetof(buffer{}.kind))
